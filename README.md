...
A commandline tool for resetting Kafka Connect source connector offsets. Based on [@rmoff](https://github.com/rmoff)'s awesome [blog post](https://rmoff.net/2019/08/15/reset-kafka-connect-source-connector-offsets/) about resetting Kafka Connect source connector offsets. 
