...
A commandline tool for resetting Kafka Connect source connector offsets. Inspired by [rmoff]'s amazing blog post [Reset Kafka Connect Source Connector Offsets](https://rmoff.net/2019/08/15/reset-kafka-connect-source-connector-offsets/).
